...
<div>
  <figure class="figure">
    <img alt="Torsion angles" src="/images/3.ramachandraw/torsion.svg" class="figure-image svg" style="max-height: 300px; width: auto;">
  </figure>
...
<div>
  <figure class="figure">
    <img alt="Single PDB" src="/images/3.ramachandraw/single.png" class="figure-image" style="border: 1px solid lightgray; border-radius: 4px; margin: 0 6px; max-width: 50%; object-fit: contain;">
    <img alt="Batch of PDBs" src="/images/3.ramachandraw/batch.png" class="figure-image" style="border: 1px solid lightgray; border-radius: 4px; margin: 0 6px; max-width: 50%; object-fit: contain;">
  </figure>
